...
import { Briefcase, LayoutDashboard, SearchCode, FileSearch, Calendar as CalendarIcon, LineChart, Moon, Sun, Users, LogOut, X, Star, Share2 } from 'lucide-react';
import { cn } from '../utils';
import { useTheme } from './ThemeContext';
import { useAuth } from './AuthContext';
import { StratosLogo } from './StratosLogo';

export type TabType = 'crm' | 'stats' | 'referrals' | 'dd' | 'calendar' | 'portfolio' | 'fundraising' | 'investors' | 'shortlist' | 'search';
